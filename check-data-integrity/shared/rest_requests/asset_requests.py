...
"""
from check.check_data.types import ElementDescription, AssetTypeDescription, AssetDescription
from shared.data.elements import get_id
from shared.rest_requests.get_response_content import get_xml_content, get_json_content
...
def __get_dc_of_series(series, base_url, digest_login):
    ...
    response = get_request(url, digest_login, ElementDescription.SERIES.unknown(), AssetTypeDescription.SERIES.singular(),
