class RequestError(Exception):
    ...
    :full message: More specific error message also containing the URL. For more serious errors to be displayed immediately.
    ...
    def with_statuscode(cls, resource_description, url, status_code):
        ...
        full_message = "Request for {} at url {} failed with status code {}.".format(resource_description, url, status_code)
