from check.check_data.types import ElementDescription
from shared.data.elements import get_id

from shared.rest_requests.get_response_content import get_xml_content
...
def get_oaipmh_record(event, repository_url, repository, digest_login, base_url):
    ...
    response = get_request(url, digest_login, ElementDescription.OAIPMH.format(repository).singular()) #TODO
