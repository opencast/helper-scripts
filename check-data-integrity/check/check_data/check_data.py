...
from check.check_data.types import AssetDescription, AssetTypeDescription
from check.check_data.create_errors import missing, more, more_series, series_not_found, no_series, asset_not_equal, \
    asset_without_series
from shared.data.compare_assets import compare_dc, compare_acl
...
def check_series_asset_of_event(assets, series_of_event, element_description, asset_description):
    ...
    if assets and (not series_of_event or isinstance(series_of_event, Malformed)):
