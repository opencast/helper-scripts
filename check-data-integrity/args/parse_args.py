...
def parse_args():
    ...
    :return: opencast url, whether to use https, the digest user and password, whether to print progress statements and
    which data to check
    """
    ...
    parser.add_argument("-e", "--exclude-tenants", type=str, nargs='+', help="list of tenants to be excluded",
                        required=False)
    ...
    return args.opencast, args.tenants, args.exclude_tenants, args.https, \
